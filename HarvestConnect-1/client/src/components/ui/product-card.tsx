...
function ProductCard({ product, showFarmerInfo = true }: ProductCardProps) {
  ...
  const rating = useMemo(() => parseFloat(product.rating || "0"), [product.rating]);
      ...
      <CardContent className="p-4">
        ...
        <div className="flex items-center justify-between mb-3">
          ...
          <span className="text-xs text-gray-500">
            {hasStock ? `${product.stock} ${product.unit} left` : 'Out of stock'}
          </span>
        </div>
        ...
        <Button 
          ...
          disabled={addToCartMutation.isPending || !hasStock}
